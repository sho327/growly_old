          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link href={`${process.env.NEXT_PUBLIC_BASE_PATH}/forgot-password`} className="text-emerald-600 hover:text-emerald-700 font-medium">
                  パスワードを忘れた方
                </Link>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-slate-600">
                アカウントをお持ちでない方は{" "}
                <Link href={`${process.env.NEXT_PUBLIC_BASE_PATH}/register`} className="text-emerald-600 hover:text-emerald-700 font-medium">
                  新規登録
                </Link>
              </p>
            </div>
