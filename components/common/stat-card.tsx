...
const colorClasses = {
  emerald: {
    ...
    overlay: "bg-gradient-to-br from-emerald-500/5 to-green-500/5"
  },
  amber: {
    ...
    overlay: "bg-gradient-to-br from-amber-500/5 to-orange-500/5"
  },
  blue: {
    ...
    overlay: "bg-gradient-to-br from-blue-500/5 to-indigo-500/5"
  },
  purple: {
  ...
  green: {
    ...
    overlay: "bg-gradient-to-br from-green-500/5 to-emerald-500/5"
  },
  red: {
    ...
    overlay: "bg-gradient-to-br from-red-500/5 to-pink-500/5"
  },
  orange: {
    ...
    overlay: "bg-gradient-to-br from-orange-500/5 to-red-500/5"
  },
  yellow: {
    ...
    overlay: "bg-gradient-to-br from-yellow-500/5 to-amber-500/5"
  }
}
...
export function StatCard({ icon, title, value, subtitle, color, change }: StatCardProps) {
  ...
  return (
    <Card className={`relative bg-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden ${colors.bg}`}>
      <div className={`absolute inset-0 ${colors.overlay} pointer-events-none`} />
